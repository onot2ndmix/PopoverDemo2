...
- (void)viewDidLoad
{
    ...
    self.popItems = [NSMutableArray array];
    for (int i = 0; i < 7; i++) {
        [_popItems addObject:[NSString stringWithFormat:@"Item%d", i+1]];
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *popItem = [_popItems objectAtIndex:indexPath.row];
    cell.textLabel.text = popItem;
